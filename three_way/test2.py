...
conflict_matrix = {
    'a_3':['c_1', 'd_3', 'd_2', 'd_1'], 
    'a_2':['c_1'], 
    'a_1':['c_3', 'c_2', 'c_1', 'd_3', 'd_1'],  
    'c_3':['a_1', 'd_3', 'd_1'],
    'c_2':['a_1', 'd_3'],
    'c_1':['a_3', 'a_2', 'a_1', 'd_3', 'd_1'],
    'd_3':['a_3', 'a_1', 'c_3', 'c_2', 'c_1'],
    'd_2':['a_3'],
    'd_1':['a_3', 'a_1', 'c_3', 'c_1']
    }
...
LANE_NUM = ['a_1','a_2','a_3','c_1','c_2','c_3','d_1','d_2','d_3']
PLATOON_SIZE = 1
SPEED = 16.6  # m/s
V2I_RANGE = 200 
...
def add_platoons(step):
    for lane in LANE_NUM:    # lane a,b,c,d
        if lane == 'a_2' or lane == 'a_3' or lane == 'c_1' or lane == 'c_3': 
            if random.random() < ADD_PLATOON_PRO_NS:
                add_single_platoon(step, lane)
        if lane == 'd_1' or lane == 'd_2':
...
def conversion(input):
    ...
    for veh in input:
        ...
        if lane_id == 'a':
            ...
            initial_list[1] = 'c_'+ fut_man
            input_list_ids[1] = veh
        elif lane_id == 'd':
            initial_list[2] = 'd_'+ fut_man
...
def my_algorithm(input):
    ...
    for i in input:
        if i!=0:
            temporary = [input[0], input[1], input[2]]
            for j in temporary:    
                if i!=j and j!=0:
    ...
    #print(first_list) 
    if first_list == [[0, 0, 0], [0, 0, 0], [0, 0, 0]]:
        return
    #-------------------
    count = []
    for x in first_list:
    ...
    for i in first_output:
        if i!=first_output[z] and i!=0:
            temp2 = [first_output[0], first_output[1], first_output[2]]
    ...
    if second_list == [[0, 0, 0], [0, 0, 0], [0, 0, 0]]:
        return first_output
    #---------------------
    count2 = []
